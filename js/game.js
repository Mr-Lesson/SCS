...
// =========================
// RUSTIC DRAWING HELPERS
// =========================
function drawStick(x, y, color="white") {
    ctx.strokeStyle = color;
    ctx.lineWidth = 2;
    ctx.beginPath();
    ctx.arc(x + (Math.random()*4-2), y + (Math.random()*4-2), 10 + Math.random()*2, 0, Math.PI*2);
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(x, y+10); ctx.lineTo(x + (Math.random()*3-1), y+40 + (Math.random()*3-1)); ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(x-12 + (Math.random()*3-1), y+20 + (Math.random()*3-1));
    ctx.lineTo(x+12 + (Math.random()*3-1), y+20 + (Math.random()*3-1)); ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(x, y+40); ctx.lineTo(x-12 + (Math.random()*2-1), y+60 + (Math.random()*2-1));
    ctx.moveTo(x, y+40); ctx.lineTo(x+12 + (Math.random()*2-1), y+60 + (Math.random()*2-1)); ctx.stroke();
}

function drawHouse(x, y, w, h) {
    ctx.fillStyle = "#6a4";
    ctx.fillRect(x + (Math.random()*2-1), y + (Math.random()*2-1), w + (Math.random()*4-2), h + (Math.random()*4-2));
    ctx.beginPath();
    ctx.moveTo(x, y);
    ctx.lineTo(x + w/2 + (Math.random()*3-1), y - h/2 + (Math.random()*3-1));
    ctx.lineTo(x+w, y);
    ctx.closePath();
    ctx.fillStyle = "#933";
    ctx.fill();
